...
public class BackgroundGeolocation extends Plugin {
    ...
    public void addWatcher(final PluginCall call) {
        ...
        SendLocationService.url = call.getString("url");
        SendLocationService.token = call.getString("token");
        SendLocationService.idRuta = call.getInt("idRuta");
    ...
    private class ServiceReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            SendLocationService service = new SendLocationService(location,context);
            service.SendLocationToServer();
